import { AppBar, Toolbar, Typography, InputBase, IconButton, styled,Button, Box } from '@mui/material';
...
const Appadsnavbar = () => {
  return (
    ...
    <Toolbar sx={{ display: 'flex', justifyContent: 'space-between' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', textAlign: 'center', gap: 2 }}>
      <StyledInputBase
        placeholder="Search..."
