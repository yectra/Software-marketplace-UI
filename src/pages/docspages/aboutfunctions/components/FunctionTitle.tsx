...
const FunctionTitle :React.FC= () => {
  return (
   <Box>
    <Typography variant="h6">About Marketplace Function APIs</Typography>
    <Box sx={{p:2,border:"1px solid black",borderRadius:4,m:2}}>
        <Typography variant="subtitle2" sx={{color:"#6D6767",m:2}}>Lorem ipsum dolor sit  Sed blandit id turpis urna enim morbi etiam. Pulvinar nunc facilisi adipiscing facilisis eleifend eget. Lectus blandit feugiat in aliquam fermentum. Imperdiet sapien ac enim pellentesque. Quis purus tortor mi magna tellus. Lorem ipsum dolor sit amet consectetur. Malesuada integer vel leo non pellentesque turpis in. Nec a proin dolor metus enim. Sed blandit id turpis urna enim morbi etiam. Pulvinar nunc facilisi adipiscing facilisis eleifend eget. Lectus blandit feugiat in aliquam fermentum. Imperdiet sapien ac enim pellentesque. Quis purus tortor mi magna tellus.</Typography>
        <Typography variant="subtitle2" sx={{color:"#6D6767",m:2}}>Lorem ipsellentesque turpis in. Nec a proin dolor metus enim. Sed blandit id turpis urna enim morbi etiam. Pulvinar nunc facilisi adipiscing facilisis eleifend eget. Lectus blandit feugiat in aliquam fermentum. Imperdiet sapien ac enim pellentesque. Quis purus tortor mi magna tellus. Lorem ipsum dolor sit amet consectetur. Malesuada integer vel leo non pellentesque turpis in. Nec a proin dolor metus enim. Sed blandit id turpis urna enim morbi etiam. Pulvinar nunc facilisi adipiscing facilisis eleifend eget. Lectus blandit feugiat in aliquam fermentum. Imperdiet sapien ac enim pellentesque. Quis purus tortor mi magna tellus.</Typography>
    </Box>
   </Box>
  )
}
