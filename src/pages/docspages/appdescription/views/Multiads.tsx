import Adsdetails from "@/pages/docspages/appdescription/components/Adsdetails"
import Marketplacefunctions from '@/pages/docspages/appdescription/assets/Marketplacefunctions.png'
import Metaobjects from '@/pages/docspages/appdescription/assets/metaobjects.png'
import UIUX from '@/pages/docspages/appdescription/assets/Extensions.png'
import Testing from '@/pages/docspages/appdescription/assets/Testing.png'

import { Box, Grid, Typography} from "@mui/material"


const Multiads:React.FC = () => {
    const adsData = [
        {
